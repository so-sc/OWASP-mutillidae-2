...
try{
	...
	$lQueryString = "INSERT INTO youTubeVideos(recordIndetifier, identificationToken, title) 
		VALUES
			...
			(36, 'UH9gx4TyFlk', 'Generate Cross Site Scripts with SQL Injection '),
			...
			(40, 'YCfInEFWbVA', 'Explanation of HTTPOnly Cookies in Presence Cross-Site Scripting'),
			...
			(54, '0_AN5FKsxaw', 'Bypass Authentication using SQL Injection'),
